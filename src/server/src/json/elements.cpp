...
template class Element_T<NullImp>;
template class Element_T<ArrayImp>;
template class Element_T<ObjectImp>;

template<>
ElementType Element_T<TrivialImpType_T<bool, BOOLEAN_ELEMENT> >::Type_i()
{
  return BOOLEAN_ELEMENT;
}

template<>
ElementType Element_T<TrivialImpType_T<std::string, STRING_ELEMENT> >::Type_i()
{
  return STRING_ELEMENT;
}

template<>
ElementType Element_T<TrivialImpType_T<double, NUMBER_ELEMENT> >::Type_i()
{
