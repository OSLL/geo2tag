...
#    define MYLOGDIR	"c:"
#  endif
  void mylog( char *fmt, ... );        /* prototype */
#else
#  ifndef WIN32
#   ifdef _GNU
#     define mylog(char*fmt,...)	/* GNU convention for variable arguments */
#   else 
#     define mylog
#   endif
#  else
...
#    define QLOGDIR		"c:"
#  endif
  void qlog(char*fmt,...);	/* prototype */
#else
#  ifndef WIN32
#    define qlog(char*fmt,...)	/* GNU convention for variable arguments */
#  else
#    define qlog    
#  endif
#endif
