...
namespace Wt
{
   ...
   * Contributed by: Richard Ulrich.
   */
  class WT_API WOpenStreetMap : public WCompositeWidget
  {
    public:
      ...
      class WT_API Coordinate
      {
         ...
         */
        WOpenStreetMap(WContainerWidget *parent = 0);

        /*! \brief Destructor.
         */
        virtual ~WOpenStreetMap();
        ...
        /*! \brief Enables the OpenStreetBar, an integrated search control, on the map.
         *
         ...
         */
        void enableOpenStreetBar();

        /*! \brief Disables the OpenStreetBar integrated search control.
         *
         * When disabled, the default Powered by OpenStreet logo occupies the
         * position formerly containing this control. Note that this control
         * is already disabled by default.
         */
        void disableOpenStreetBar();
...
#endif                                                      // OPENSTREETMAP_H_INCLUDED
